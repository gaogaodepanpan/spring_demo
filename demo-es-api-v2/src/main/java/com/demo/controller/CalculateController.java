...
import com.demo.pojo.CommonObj;
import com.demo.pojo.DifferUser;
import com.demo.pojo.FilterObj;
import com.demo.pojo.TimeTable;
...
//    public void calById() throws Exception {
//        calDiffertest(3,4);
//
//    }
...
//			Thread.sleep(30000*1);
    ...
    @GetMapping("/calculating")
    public String calDiffertest(@RequestParam(value = "basid") long baseline_Id, @RequestParam(value = "curid") long current_Id) throws Exception { //long baseline_Id, long current_Id
